...
import { getModelSelectionStringOptionValue } from "@termweave/shared/model";
import { extractJsonObject } from "@termweave/shared/schemaJson";
      ...
      Effect.tryPromise({
        try: async () => {
          ...
          const session = await client.session.create({
            title: `Termweave ${input.operation}`,
