 ...
 */
import { IsoDateTime, ProjectId, ProjectScript } from "@termweave/contracts";
...
>()("termweave-server/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
