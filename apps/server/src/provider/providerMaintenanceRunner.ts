...
>()("termweave-server/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Termweave could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Termweave still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
